    ...
    <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
        <div class="mt-3">
            ...
            <form id="create-task-form" onsubmit="createTask(event)">
                ...
                <div class="mb-4" id="assign-users-block">
                    <label for="task-user-ids" class="block text-sm font-medium text-gray-700 mb-2">Assigner à</label>
                    <select 
                        id="task-user-ids"
                        name="user_ids[]"
                        multiple
                    ...
                    <small class="text-gray-500">Seuls les membres du projet peuvent être assignés</small>
                </div>
